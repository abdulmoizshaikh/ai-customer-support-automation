...
7. [The Ticket Workflow (Core Orchestration)](#7-the-ticket-workflow-core-orchestration)
8. [Data Model](#8-data-model)
9. [Environment Variables](#9-environment-variables)
10. [Development Workflow](#10-development-workflow)
11. [Testing](#11-testing)
12. [Database Operations](#12-database-operations)
13. [AI Providers and Switching](#13-ai-providers-and-switching)
...
## 7. The Ticket Workflow (Core Orchestration)
...
**Why no transaction:** LLM and embedding calls can take 30+ seconds. Holding a transaction open across them causes timeouts (learned the hard way — see [Known Issues](#18-known-issues-and-gotchas)).
...
You're holding a transaction across an LLM call. Restructure to move the LLM call outside the transaction. See [Section 7](#7-the-ticket-workflow-core-orchestration).
